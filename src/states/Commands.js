...
class Commands extends Phaser.State {
  ...
  create() {
    ...
    this.game.add.text(150, 200, "Move", { font: "bold 32px Arial", fill: TextColor });
    this.game.add.text(500, 200, moveText, { font: "bold 32px Arial", fill: TextColor });

    this.game.add.text(150, 275, "Aim", { font: "bold 32px Arial", fill: TextColor });
    this.game.add.text(500, 275, aimText, { font: "bold 32px Arial", fill: TextColor });

    this.game.add.text(150, 350, "Erase Layer", { font: "bold 32px Arial", fill: TextColor });
    this.game.add.text(500, 350, eraseLayer, { font: "bold 32px Arial", fill: TextColor });

    this.game.add.text(150, 425, "Rollback Layer", { font: "bold 32px Arial", fill: TextColor });
