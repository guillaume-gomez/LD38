...
import { Tileset, Level1 } from '../ConstantsKey.js';
...
class MainView extends Phaser.State {
  ...
  create() {
    ...
    this.hero = new Character(this.game, 20 , 300, "hero", 0);
  ...
  preload() {
    this.game.load.spritesheet("hero", "res/hero.png", WidthSpriteSheetHero, HeightSpriteSheetHero);
